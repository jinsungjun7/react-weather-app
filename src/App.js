...
function App() {
  ...
  return (
    ...
    <div className={`mx-auto max-w-screen-md mt-0 mb-0 md:mb-4 md:mt-4 py-5 px-4 md:px-32 h-fit shadow-xl shadow-gray-400  ${getBackgroundColor()}`} style={{paddingBottom: '2rem'}}>
